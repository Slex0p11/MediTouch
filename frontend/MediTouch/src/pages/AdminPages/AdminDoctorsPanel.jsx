...
const AdminDoctorsPanel = () => {
  ...
  const fetchPendingDoctors = async () => {
    try {
      const response = await axios.get('http://127.0.0.1:8000/api/admin/doctors/pending/');
  ...
  const handleApprove = async (doctorId) => {
    try {
      await axios.patch(`http://127.0.0.1:8000/api/admin/doctors/approve/${doctorId}/`);
          ...
          <div className="w-full max-w-5xl">
            {pendingDoctors.length === 0 ? (
              <div className="bg-white rounded-lg shadow p-6 text-center">
                <div className="text-gray-500 text-lg">No pending doctor registrations</div>
                  ...
                  <div key={doctor.id} className="bg-white rounded-xl shadow-md overflow-hidden hover:shadow-lg transition-shadow">
                    <div className="p-6">
                      <div className="flex items-center space-x-4 mb-4">
                        ...
                        <div>
                          <h3 className="text-lg font-semibold text-gray-800">{doctor.first_name} {doctor.last_name}</h3>
                      ...
                      <div className="space-y-3 text-sm text-gray-600">
                        ...
                        <div className="flex items-center">
                          ...
                          <div className="flex space-x-3">
                            <a href={doctor.license_url} target="_blank" rel="noopener noreferrer" className="text-blue-600 hover:underline">View License</a>
                            <a href={doctor.degree_url} target="_blank" rel="noopener noreferrer" className="text-blue-600 hover:underline">View Degree</a>
                          </div>
                        </div>
                        <div className="flex items-center">
                          <svg xmlns="http://www.w3.org/2000/svg" className="h-5 w-5 mr-2 text-gray-400" fill="none" viewBox="0 0 24 24" stroke="currentColor">
