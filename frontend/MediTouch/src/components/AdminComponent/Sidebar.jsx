...
const Sidebar = () => {
  return (
    <>
      ...
      <Link to="javascript:void(0)"><img src="https://i.imgur.com/Pul2AD6.png" alt="logo" className='w-[160px]' />
      </Link>

      <ul className="mt-6">
        <li>
          <Link to="/medicineadmin/dashboard"
            className="text-black hover:text-blue-600 text-sm flex items-center hover:bg-blue-50 rounded px-4 py-3 transition-all">
            <svg xmlns="" fill="currentColor" className="w-[18px] h-[18px] mr-4"
              viewBox="0 0 512 512">
              <path
      ...
      <div className="mt-6">
        ...
        <ul className="mt-3">
          <li>
            <Link to="/medicineadmin/medicinelist"
              className="text-black hover:text-blue-600 text-sm flex items-center hover:bg-blue-50 rounded px-4 py-3 transition-all">
              <svg xmlns="" fill="currentColor" className="w-[18px] h-[18px] mr-4"
                viewBox="0 0 512 512">
                <path
          ...
          <li>
            <Link to="/medicineadmin/addmedicine"
              className="text-black hover:text-blue-600 text-sm flex items-center hover:bg-blue-50 rounded px-4 py-3 transition-all">
              <svg xmlns="" fill="currentColor" className="w-[18px] h-[18px] mr-4"
                viewBox="0 0 24 24">
                <path
          ...
          <li>
            <Link to="/medicineadmin/categorylist"
              className="text-black hover:text-blue-600 text-sm flex items-center hover:bg-blue-50 rounded px-4 py-3 transition-all">
              <svg xmlns="" fill="currentColor" className="w-[18px] h-[18px] mr-4"
                viewBox="0 0 512 512">
                <path
          ...
          <li>
            <Link to="/medicineadmin/addcategory"
              className="text-black hover:text-blue-600 text-sm flex items-center hover:bg-blue-50 rounded px-4 py-3 transition-all">
              <svg xmlns="" fill="currentColor" className="w-[18px] h-[18px] mr-4"
                viewBox="0 0 24 24">
                <path
