      ...
      <header className='flex shadow-md py-4 px-4 sm:px-10 bg-[#0076C1] font-poppin min-h-[70px] tracking-wide relative z-50 m-0'>
        <div className='flex flex-wrap items-center justify-between gap-5 w-full'>
          <Link to="javascript:void(0)">
            <img src="https://i.imgur.com/Pul2AD6.png" alt="logo" className='md:w-[70px] w-10 mx-auto' />
          </Link>
          ...
          <div id="collapseMenu" className='max-lg:hidden lg:!block max-lg:before:fixed max-lg:before:bg-black max-lg:before:opacity-50 max-lg:before:inset-0 max-lg:before:z-50'>
            ...
            <ul className='lg:flex gap-x-5 max-lg:space-y-3 max-lg:fixed max-lg:bg-white max-lg:w-1/2 max-lg:min-w-[300px] max-lg:top-0 max-lg:left-0 max-lg:p-6 max-lg:h-full max-lg:shadow-md max-lg:overflow-auto z-50'>
              ...
              <li className='max-lg:border-b border-gray-300 max-lg:py-3 px-3'>
                <Link to='javascript:void(0)' className='hover:text-[#FF0000] text-[#000000] block font-semibold text-[15px]'>Home</Link>
              </li>
              <li className='max-lg:border-b border-gray-300 max-lg:py-3 px-3'>
                <Link to='javascript:void(0)' className='hover:text-[#FF0000] text-[#000000] block font-semibold text-[15px]'>Pharmacy</Link>
              </li>
              <li className='max-lg:border-b border-gray-300 max-lg:py-3 px-3'>
                <Link to='javascript:void(0)' className='hover:text-[#FF0000] text-[#000000] block font-semibold text-[15px]'>Appointments</Link>
              </li>
              <li className='max-lg:border-b border-gray-300 max-lg:py-3 px-3'>
                <Link to='javascript:void(0)' className='hover:text-[#FF0000] text-[#000000] block font-semibold text-[15px]'>Cart</Link>
              </li>
              <li className='max-lg:border-b border-gray-300 max-lg:py-3 px-3'>
                <Link to='javascript:void(0)' className='hover:text-[#FF0000] text-[#000000] block font-semibold text-[15px]'>About</Link>
              </li>
            </ul>
          </div>
